...
function NavigationButtons({
    ...
    return (
        <ButtonGroup variant="outlined" size="small">
            <Button
                onClick={() =>
                    ComponentAdd(callback_id, fktContext.watchedValues, fktContext.setStateUpdate)
                }
            >
                <AddIcon />
            </Button>
            <Button
                ...
                onClick={() =>
                    ComponentDelete(
                        callback_id,
                        fktContext.watchedValues,
                        fktContext.setStateUpdate
                    )
                }
            >
                <DeleteForeverIcon />
            ...
            <Button
                disabled={disableUp}
                onClick={() =>
                    ComponentUp(callback_id, fktContext.watchedValues, fktContext.setValue)
                }
            >
                <ArrowCircleUpIcon />
            </Button>
            <Button
                ...
                onClick={() =>
                    ComponentDown(callback_id, fktContext.watchedValues, fktContext.setValue)
                }
            >
                <ArrowCircleDownIcon />
            </Button>
