            ...
            <Controller
                ...
                render={({ field }) => (
                    <Select key={name + '_s'} {...field} label={label} variant={variant}>
                        <MenuItem key={name + '_i_0'} value={0}>
                            0s
                        </MenuItem>
                        <MenuItem key={name + '_i_5'} value={5}>
                            5s
                        </MenuItem>
                        <MenuItem key={name + '_i_10'} value={10}>
                            10s
                        </MenuItem>
                        <MenuItem key={name + '_i_20'} value={20}>
                            20s
                        </MenuItem>
                        <MenuItem key={name + '_i_30'} value={30}>
                            30s
                        </MenuItem>
                        <MenuItem key={name + '_i_45'} value={45}>
                            45s
                        </MenuItem>
                        <MenuItem key={name + '_i_60'} value={60}>
                            60s
                        </MenuItem>
                    </Select>
                )}
