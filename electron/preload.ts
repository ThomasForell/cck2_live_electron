...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    saveSingleSetup: (data) => { ipcRenderer.send("save_single_setup", data) },
    saveSprintSetup: (data) => { ipcRenderer.send("save_sprint_setup", data) },
    ...
    singleProcessingStart: () => { ipcRenderer.send("single_processing_start") },
    singleProcessingStop: () => { ipcRenderer.send("single_processing_stop") },
    sprintProcessingStart: () => { ipcRenderer.send("sprint_processing_start") },
    sprintProcessingStop: () => { ipcRenderer.send("sprint_processing_stop") },
